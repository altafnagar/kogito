...
public class CustomHumanTaskLifeCycle implements LifeCycle<Map<String, Object>> {
    ...
    public Map<String, Object> data(KogitoWorkItem workItem) {
        System.out.println("workitem getNodeInstance:"+workItem.getNodeInstance().getNodeDefinitionId());
        System.out.println("workitem getNodeInstance:"+workItem.getNodeInstance().getNodeName());
        System.out.println("workitem getNodeInstance:"+workItem.getNodeInstance().getNodeId());    
        System.out.println("workitem getProcessInstance:"+workItem.getProcessInstance().getId());    
        System.out.println("workitem getProcessId:"+workItem.getProcessInstance().getProcessId());   
         System.out.println("workitem getName:"+workItem.getName());
        System.out.println("workitem getPhaseId:"+workItem.getPhaseId());
        System.out.println("workitem getPhaseStatus:"+workItem.getPhaseStatus());
        System.out.println("workitem getProcessInstanceId:"+workItem.getProcessInstanceId());
        System.out.println("workitem getStartDate:"+workItem.getStartDate());
        System.out.println("\n");
